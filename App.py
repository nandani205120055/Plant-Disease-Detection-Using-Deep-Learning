...
add_bg_from_local('C:/Users/Friends/Downloads/PlantDiseaseDetection_f/PlantD_D/2.jpg')    
...
st.markdown("<h4 style='color: brown;'>A ResNet 34-based Algorithm for Robust Plant Disease Detection with 99.3% Accuracy Across 39 Different Classes of Plant Leaf Images.</h4>", unsafe_allow_html=True)
